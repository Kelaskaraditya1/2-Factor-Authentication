package com.starkIndustries.RoleBasedAuthorization.redis.configuration;
...
public class RedisConfiguration {
    ...
    public CacheManager getCacheManager(RedisConnectionFactory redisConnectionFactory){
        ...
        Jackson2JsonRedisSerializer<Object> jackson2JsonRedisSerializer = this.getJacksonSerializable();
